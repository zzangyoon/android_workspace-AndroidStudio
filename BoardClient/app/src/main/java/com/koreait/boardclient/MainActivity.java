...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(Looper.getMainLooper()){
            //handleMessage 영역은 UI를 제어할 수 있는 영역이다
            @Override
        ...
        Thread thread = new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    httpManager.requestByPost("http://172.30.1.1:7777/rest/board", json.toString());
    ...
    public void getList(View view){
        ...
        Thread thread = new Thread(){
            @Override
            public void run() {
                ArrayList<Board> boardList = httpManager.requestByGet("http://172.30.1.1:7777/rest/board");
