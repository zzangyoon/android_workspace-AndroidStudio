...
public class ImageDownLoaderAsync extends AsyncTask<String, Void, Bitmap> {
    ...
    public ImageDownLoaderAsync(GalleryFragment galleryFragment, Gallery gallery) {
        this.galleryFragment = galleryFragment;
        this.gallery = gallery;
    }

    //웹서버 요청전에 하고싶은 작업은 여기서 하자(메인쓰레드가 수행. 따라서 UI제어 가능)
   ...
   protected void onProgressUpdate(Void... values) {
    ...
    //웹서버 요청 완료 후에 하고싶은 작업은 여기서 하자(메인쓰레드가 수행. 따라서 UI제어 가능)
