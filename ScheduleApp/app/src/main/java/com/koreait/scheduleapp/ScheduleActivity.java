...
public class ScheduleActivity extends AppCompatActivity {
    ...
    int year;
    int month;
    Calendar cal;   //최종적으로 출력시 사용할 날짜 객체
                            // 이 객체를 사용하면 더이상 제목에 출력되는 데이터가 순수한 정수가 아닌, 날짜 정보로 출력될 수 있다!
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableLayout = this.findViewById(R.id.tableLayout);  //view 받아놓기
    ...
    public void createCell(){
        ...
        for(int a=0; a<7; a++){ //7층짜리 테이블의 row
            ...
            TableRow tableRow = (TableRow) layoutInflater.inflate(R.layout.item_row, tableLayout, false);  //xml을 인플레이션
            ...
            tableLayout.addView(tableRow);//각 층을 테이블에 부착
        }
    }
